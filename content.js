...
function renderError(
    ...
    host.innerHTML = `
        <section
            ...
            <article
                class="content-card qafiyah-detail-card qafiyah-error-card">
...
function renderVideo(
    ...
    if (youtube) {
        ...
        return `
            <div
                class="video-box qafiyah-video-box">
...
async function initArticlesList() {
    ...
    try {
                ...
                filtered
                    ...
                    .map(
                        function (
                            ...
                            return `
                                <article
                                    class="content-card qafiyah-content-card">
        ...
        container.innerHTML = `
            <div
                class="qafiyah-content-status qafiyah-content-error">
                ...
                filtered
                    ...
                    .map(
                        function (
                            ...
                            return `
                                <article
                                    class="content-card qafiyah-content-card qafiyah-poet-card">
...
async function initPoemsList() {
    ...
    section.innerHTML = `
        ...
        <div
            ...
            <section
                class="articles-toolbar qafiyah-poems-toolbar">
                ...
                filtered
                    ...
                    .map(
                        function (
                            ...
                            return `
                                <article
                                    class="content-card qafiyah-content-card qafiyah-poem-index-card">
                                    ...
                                    <div
                                        ...
                                        ${
                                            poem.poet
                                                ...
                                                `
                                                    <p
                                                        class="poem-poet qafiyah-card-meta">
    ...
    try {
        ...
        host.innerHTML = `
            <section
                ...
                <article
                    class="content-card qafiyah-detail-card">
    ...
    try {
        ...
        host.innerHTML = `
            <section
                ...
                <article
                    class="content-card qafiyah-detail-card qafiyah-poet-detail-card">
    ...
    try {
        ...
        host.innerHTML = `
            <section
                ...
                <article
                    class="content-card poem-card qafiyah-detail-card qafiyah-poem-detail-card">
                    ...
                    <header
                        class="poem-card-header qafiyah-detail-header">
                        ...
                        <div>
                            ...
                            ${
                                poetName
                                    ...
                                    `
                                        <p
                                            class="poem-poet qafiyah-detail-poet">
                    ...
                    <div
                        class="poem-text qafiyah-poem-lines">
