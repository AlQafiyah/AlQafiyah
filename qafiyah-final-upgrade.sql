...
-- قراءة ملفات المستخدمين من لوحة الإدارة: للمالك وحده.
...
for select to authenticated using (public.qafiyah_my_role()='owner');

-- بيانات المستخدمين العاديين: للمالك وحده، حتى عند استدعاء RPC مباشرة.
